...
namespace FungleVST.Midi
{
    ...
    internal sealed class Plugin : VstPluginWithInterfaceManagerBase
    {
        ...
        /// </summary>
        private static readonly int UniquePluginId = new FourCharacterCode("5432").ToInt32();
        /// <summary>
        /// TODO: assign a plugin name.
        /// </summary>
        private const string PluginName = "Fungle Midi";
        /// <summary>
        /// TODO: assign a product name.
        /// </summary>
        private const string ProductName = "Fungle";
        /// <summary>
        /// TODO: assign a vendor name.
        /// </summary>
        private const string VendorName = "LoadedDog";
        /// <summary>
