namespace Jacobi.Vst.Samples.MidiNoteMapper
{
    ...
    class Plugin : VstPluginWithInterfaceManagerBase, IVstPluginMidiSource
    {
        ...
        /// </summary>
        public Plugin()
            : base("VST.NET Midi Note Mapper", new VstProductInfo("VST.NET Code Samples", "Jacobi Software (c) 2011", 1000),
                VstPluginCategory.Effect, VstPluginCapabilities.ReceiveTimeInfo, 0, 0x30313233)
        {
