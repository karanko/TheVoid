...
namespace Spinal.Doomo
{
    ...
    internal sealed class Plugin : VstPluginWithInterfaceManagerBase
    {
        ...
        /// </summary>
        private static readonly int UniquePluginId = new FourCharacterCode("8089").ToInt32();
        /// <summary>
        /// TODO: assign a plugin name.
        /// </summary>
        private const string PluginName = "Spinal Doomo";
        /// <summary>
        /// TODO: assign a product name.
        /// </summary>
        private const string ProductName = "Spinal";
        /// <summary>
